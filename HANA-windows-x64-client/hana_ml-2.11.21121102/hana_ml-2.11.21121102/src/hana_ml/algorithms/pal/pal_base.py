...
class PALBase(hana_ml.ml_base.MLBase, ModelSavingServices):
    ...
    def _call_pal_auto(self, conn_context, funcname, *args):
        ...
        try:
            ...
            if call_string:
                if "PREDICT" in call_string.upper() or "FORECAST" in call_string.upper() or "CLASSIFY" in call_string.upper() or "EXPLAIN" in call_string.upper():
