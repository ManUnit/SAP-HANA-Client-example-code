...
class AutoARIMA(_AutoARIMABase):
    ...
    background_size : int, optional
        Indicates the nubmer of data points used in AutoARIMA with explainations in the predict function.
        If you want to use the AutoARIMA with explainations, you must set ``background_size`` to be larger than 0 or -1(auto mode)
